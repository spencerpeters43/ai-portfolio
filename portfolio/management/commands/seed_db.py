...
PROJECTS = [
    {
        ...
        'screenshot': 'screenshots/chatbot_screenshot.png',
        'video': '',
        'downloadable_file': '',
        'is_featured': True,
        'order': 1,
...
SKILLS = [
    ('Excel Modeling & Dashboards',   'Technical Skills'),
    ('Python & SQL',                  'Technical Skills'),
    ('AI Workflow Automation',        'Technical Skills'),
    ('Prompt Engineering',            'Technical Skills'),
    ('n8n Automated Workflows',       'Technical Skills'),
    ('Data Analysis & Visualization', 'Technical Skills'),
...
class Command(BaseCommand):
    help = 'Seed the database with projects and skills (skips if data already exists)'
    ...
    def _seed_projects(self):
        ...
        self.stdout.write(self.style.SUCCESS(f'Loaded {len(PROJECTS)} projects.'))
    ...
    def _seed_skills(self):
        ...
        self.stdout.write(self.style.SUCCESS(f'Loaded {len(SKILLS)} skills.'))
